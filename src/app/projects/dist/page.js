...
var ProjectsPage = function () {
    ...
    var _b = queries_1.projectQueries.getPosts("current-page=" + pageIndex + "&per-page=15"), data = _b.data, isLoading = _b.isLoading;
    ...
    return (react_1["default"].createElement(PageLayout_1["default"], null,
        react_1["default"].createElement("div", { className: "py-[100px] text-center" },
            react_1["default"].createElement("div", { className: "container" },
                react_1["default"].createElement("h5", { className: "font-unbounded text-5xl font-semibold uppercase" }, "Latest Projects"))),
        react_1["default"].createElement("div", { className: "container pb-[60px] space-y-10" },
            react_1["default"].createElement("div", { className: "grid grid-cols-3 gap-6" }, isLoading ? "Loading..." :
                data && data.projects.map(function (project, index) { return (react_1["default"].createElement(CardProject_1["default"], { key: project.id, post: project })); })),
