...
var Card = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement("div", __assign({ ref: ref, className: utils_1.cn("rounded-none border border-black bg-card text-card-foreground shadow-none", className) }, props)));
});
exports.Card = Card;
