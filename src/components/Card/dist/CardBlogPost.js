...
var CardBlogPost = function (_a) {
    var post = _a.post;
    return (react_1["default"].createElement(card_1.Card, { className: 'h-full group/item relative flex flex-col border border-black before:transition-all before:duration-300 before:ease-linear before:content-[""] before:w-full before:h-full before:bg-black before:absolute before:end-0 before:z-[-1] before:translate-y-0 hover:before:-end-[0.35rem] hover:before:translate-y-[0.35rem]' },
        ...
        react_1["default"].createElement(card_1.CardContent, { className: 'space-y-3' },
            react_1["default"].createElement("div", null, post.excerpt)),
